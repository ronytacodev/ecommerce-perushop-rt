                ...
                <v-col cols="3" class="py-0 pr-0 mt-n3">
                    ...
                    <v-card flat outlined tile>
                        ...
                        <v-chip-group column multiple>
                            ...
                            <v-chip filter color="#7C5F40" text-color="white"></v-chip>
            ...
            <v-row>
                ...
                <v-col cols="12" sm="12">
                    <h6 class="text-center grey--text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus obcaecati suscipit
                        distinctio consequatur sed eveniet rerum, excepturi sequi maiores sit placeat tempora quod. Pariatur
                        tempora, libero consequuntur a deserunt optio.
                    </h6>
                </v-col>
                <v-col cols="12" sm="12">
