            ...
            <v-row>
                <v-col cols="12" sm="4">
                    ...
                    <v-card-text class="grey--text pt-0">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quibusdam illum temporibus iste,
                        asperiores minus! Dolores esse tempore hic eveniet odio nesciunt animi aut porro quae ut. Expedita,
                        blanditiis necessitatibu.
                    </v-card-text>
